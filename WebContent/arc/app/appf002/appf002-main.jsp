...
<div class="col-xs-12 nopadding">
	...
	<form id="frm_main" class="form-horizontal" data-role="form" >
		...
		<div class="col-xs-12">
			<acf:Grid id="grid_browse" url="appf002-search.ajax" readonly="true" autoLoad="false">
...
Controller.setOption({
	...
	getUrl: "appf002-get-form.ajax",
	saveUrl: "appf002-save.ajax",
ready: function() { Action.setMode("search"); }		
}).executeSearchBrowserForm();

$(document).on('new', function() {
	$("#frm_main #section_id").setValue("04");//testing 2
});
