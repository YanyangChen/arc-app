...
<div class="col-xs-12 nopadding">
	...
	<acf:Region id="reg_div_list" type="list" title="PURCHASE ORDER LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="grid_browse" url="appf003-search.ajax" readonly="true" autoLoad="false">
	...
	<acf:Region id="mod_main" title="PURCHASE ORDER MAINTENANCE" type="form">
	    ...
	    <div class="col-md-11">
			...
			<acf:Bind on="click">
					...
					//	}
						...
						async  : false,
						type   : "POST",
						url    : "${ctx}/arc/app/appf003/appf003-generate-report.ajax",
						data   : JSON.stringify({
    	...
    	<div class="col-xs-12 form-padding oneline">
     		<label class="control-label col-md-2" for="department_reference_no">Dept.Ref. No.:</label>
      		...
      		<div class="hidden">  
      			<acf:DateTime id="latest_receive_date" name="latest_receive_date" />
      			...
      			<acf:Bind on="change" modified="true"><script>
   						...
   						if (supplier_code == ""){
	   						...
	   						$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/app/app-get-supplier-desc.ajax",
								data   : JSON.stringify({
...
<!--  	<div class="col-xs-12 form-padding oneline">
	...
	<acf:Region id="item_details" title="ITEM DETAILS" type="form">			
		<div class="col-md-12">
			<acf:Grid id="grid_item" url="appf003-get-item-table.ajax" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
...
// 				if( $(this).getValue().substring(3,7) != "9999" ){
//       				$(this).setError(ACF.getQtipHint("APP004V"), "APP004V");
// 			   	}
// 			   	if ( $(this).getValue() <= today && ($(this).getValue() > ($("#frm_main #purchase_order_date").getValue())))
// 			   	{
// 			   		$(this).setError("", "APP004V");
...
Controller.setOption({
	...
	getUrl: "appf003-get-form.ajax",
	saveUrl: "appf003-save.ajax",
...
$(document).on('new', function() {
	...
	$("#frm_main #TKO").enable();
			//$.ajax({//generate new pruchase order number
				...
				//				async  : false,
				//				type   : "POST",
				//				url    : "${ctx}/arc/app/appf003/appf003-generate-name.ajax",
				//				//"${ctx}/arc/app/appf003/appf003-generate-name.ajax"
				//				data   : JSON.stringify({
				//					//'supplier_code'	: supplier_code,
				//				}),
				//				success: function(data) {
