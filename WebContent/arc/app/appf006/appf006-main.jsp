...
<div class="col-xs-12 nopadding">
	...
	<form id="frm_main" class="form-horizontal" data-role="form" >
		...
		<div class="col-xs-12">
			<acf:Grid id="grid_browse" url="appf006-search.ajax" readonly="true" autoLoad="false">
...
// 									console.log(data.item.length);
				...
				$.ajax({ //grid combobox and multi-value input
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/app/app-item-fields.ajax",
								data   : JSON.stringify({
									'item_no'	: item_no
								}),
								success: function(data) {
...
// 										$("#frm_main #unit_cost").setValue(data.unit_cost);
							...
							if (errb)
							{
							$(this).setError(err, "APP305V");
							
							}
							else
							{
							$(this).setError("", "APP305V");
							}
				</script>
				</acf:Bind>
      			   </acf:ComboBox>
...
Controller.setOption({
	...
	getUrl: "appf006-get-form.ajax",
	saveUrl: "appf006-save.ajax",
