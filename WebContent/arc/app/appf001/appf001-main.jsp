...
<div class="col-xs-12 nopadding">
	...
	<acf:Region id="reg_div_list" type="list" title="ITEM LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="grid_browse" url="appf001-search.ajax" readonly="true" autoLoad="false">
     		...
     		<label class="control-label col-md-2" for="material_type">Material Type:</label>
      		<div class="col-md-4">  
      			<acf:ButtonGroup id="material_type" name="material_type" type="radio" checkMandatory="true">
	      				<setting>
			    			<option id="material_type1" value="1" label="report in item" />
			    			<option id="material_type2" value="2" label="report in category" />
			    			<option id="material_type3" value="3" label="misc materials" />
			    		</setting>
...
<!--       			     format="^(([0-9]){0,5}[.]([0-9]){0,2})$" -->
    ...
    <acf:Region id="remaining_inventory" type="form" title="INVENTORY LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="remaining_browse" url="appf001-get-remaining-inventory.ajax" autoLoad="false" addable="false" deletable="false" editable="true" rowNum="9999" multiLineHeader="true">
	 ...
	 <acf:Region id="adjustment_inventory" type="form" title="ADJUSTMENT LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="adjust_browse" url="appf001-get-remaining-inventory.ajax" autoLoad="false" addable="false" deletable="false" editable="true" rowNum="9999" multiLineHeader="true">
	...
	<acf:Region id="inventory" type="form" title="PENDING DELIVERY">
		...
		<div class="col-xs-12">
			<acf:Grid id="inventory_browse" url="appf001-get-inventory.ajax" autoLoad="false" addable="false" deletable="false" editable="true" rowNum="9999" multiLineHeader="true">
				<acf:Column name="purchase_order_no" caption="Purchase Order No" width="100"></acf:Column>
				<acf:Column name="purchase_order_date" caption="Purchase Order Date" type="date" width="100"></acf:Column>
...
Controller.setOption({
	...
	getUrl: "appf001-get-form.ajax",
	saveUrl: "appf001-save.ajax",
...
$("#frm_main #material_type").disable();
