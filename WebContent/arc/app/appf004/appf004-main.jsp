...
<div class="col-xs-12 nopadding">
	...
	<form id="frm_main" class="form-horizontal" data-role="form" >
		...
		<div class="col-xs-12">
			<acf:Grid id="grid_browse" url="appf004-search.ajax" readonly="true" autoLoad="false">
	...
	<acf:Region id="receipt_list" type="list" title="ITEM LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="receipt_browse" url="appf004-get-inventory-table.ajax" editable="true" autoLoad="false" addable="false" deletable="false" editable="true" rowNum="9999" multiLineHeader="true">
			...
			if( newValue < 0 )
				{
					return ACF.getQtipHint("APP104V");
			   		}
...
Controller.setOption({
	...
	getUrl: "appf004-get-form.ajax",
	saveUrl: "appf004-save.ajax",
	...
	getSaveData: function() {
		...
		return JSON.stringify({
			...
			'Total' : $("#receipt_browse").pGrid$getSumOfColumn("received_quantity"),
