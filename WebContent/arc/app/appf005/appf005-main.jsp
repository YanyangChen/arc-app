...
<div class="col-xs-12 nopadding">
	...
	<form id="frm_main" class="form-horizontal" data-role="form" >
		<acf:Region id="reg_div_list" type="list" title="CONSUMPTION FORM LIST">
   		<acf:RegionAction>
		...
		<div class="col-xs-12">
			<acf:Grid id="grid_browse" url="appf005-search.ajax" readonly="true" autoLoad="false">
		...
		<acf:Region id="reg_func_main" type="form" title="MATERIAL CONSUMPTION MAINTENANCE">
     		...
     		<label class="control-label col-md-2" for="completion_date">Completion Date:</label>
      		<div class="col-md-2">
      			...
      			if( $(this).getValue() >  today ){
      				$(this).setError(ACF.getQtipHint("APP005V"), "APP005V");
			   	}
			   	if ( $(this).getValue() <= today )
			   	{
			   		$(this).setError("", "APP005V");
     		...
     		<label class="control-label col-md-2" for="location_code">Location Code:</label>
      		<div class="col-md-3">
				...
				$.ajax({ //grid combobox and multi-value input
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/app/app-get-location-name.ajax",
								data   : JSON.stringify({
     		...
     		<label class="control-label col-md-2" for="programme_no">Programme No.:</label>
      		<div class="col-md-3">
				...
				$.ajax({ //grid combobox and multi-value input
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/app/app-programme-fields.ajax",
								data   : JSON.stringify({
    	...
    	<div class="col-xs-12 form-padding">
     		<label class="control-label col-md-2" for="from_episode_no">Episode No.From.:</label>
      		<div class="col-md-1">
      			...
      			{
      				$(this).setError(ACF.getQtipHint("APP205V"), "APP205V");
			   	}
			   	
			   	else
			   	{
					$(this).setError("", "APP205V");
					$("#frm_main #to_episode_no").setError("", "APP205V");
			   	}
      				</script>
      				</acf:Bind>
      			   </acf:TextBox>
     		...
     		<label class="control-label col-md-1" for="to_episode_no">To.:</label>
      		<div class="col-md-1">
      			...
      			if( ($(this).getValue() < ($("#frm_main #from_episode_no").getValue())))
      			{
			   	...
			   	{
					$(this).setError("", "APP205V");
					$("#frm_main #from_episode_no").setError("", "APP205V");
			   	}
      				</script>
      				</acf:Bind>
      			   </acf:TextBox>
     		...
     		<label class="control-label col-md-2" for="group_no">Group No.:</label>
      		<div class="col-md-3">
				...
				$.ajax({ //grid combobox and multi-value input
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/app/app-get-group-name.ajax",
								data   : JSON.stringify({
									'group_no'	: group_no
								}),
								success: function(data) {
...
<!--      		<label class="control-label col-md-2" for="group_name">Desc./ Remark of Group:</label> -->
    	...
    	<div class="col-xs-12 form-padding">
        	...
        	<label class="control-label col-md-1" for="cancel_date">Cancel Date:</label>
      		<div class="col-md-2">
      			<acf:DateTimePicker id="cancel_date" name="cancel_date" maxlength="8" readonly="true" pickTime="false"  useDefValIfEmpty="true">
 		...
 		<div class="col-xs-12 form-padding">
     		...
     		<label class="control-label col-md-1" for="cut_off_date">Cut-off Date:</label>
      		<div class="col-md-2">
      			<acf:DateTimePicker id="cut_off_date" name="cut_off_date" maxlength="8" readonly="true" pickTime="false"  useDefValIfEmpty="true"/> 
      		</div>
    	</div>
	...
	<acf:Region id="Item_consumption" type="form" title="ITEM LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="item_browse" url="appf005-get-consumption-item.ajax" editable="true" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
				<acf:Column name="item_no" caption="ITEM No." width="100" editable="true" type="select" checkMandatory="true" columnKey="false" maxlength="7" initData="${itemnoselect}" >
				<acf:Bind on="validate"><script>
				...
				$.ajax({ //grid combobox and multi-value input
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/app/app-item-inv.ajax",
								data   : JSON.stringify({
				...
				$.ajax({ //grid combobox and multi-value input
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/app/app-item-mas.ajax",
								data   : JSON.stringify({
									'item_no'	: records.item_no
								}),
								success: function(data) {
				...
				if( newValue < 0 )
				{
					return ACF.getQtipHint("APP105V");
			   		}
	...
	<acf:Region id="Other_material_consumption" type="form" title="MATERIAL LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="material_browse" url="appf005-get-material-consumption.ajax" editable="true" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
				...
				$.ajax({ //grid combobox and multi-value input
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/app/app-other-material-unitcost.ajax",
								data   : JSON.stringify({
				...
				<acf:Column name="unit_cost" caption="Unit Cost" width="100" editable="false" checkMandatory="true">
	...
	<acf:Region id="Labour_consumption" type="form" title="LABOUR LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="labour_browse" url="appf005-get-labour-consumption.ajax" editable="true" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
				...
				$.ajax({ //grid combobox and multi-value input
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/app/app-labour.ajax",
								data   : JSON.stringify({
...
Controller.setOption({
	...
	getUrl: "appf005-get-form.ajax",
	saveUrl: "appf005-save.ajax",
...
$("#frm_main #section_id").setValue("04");
var today = new Date();
