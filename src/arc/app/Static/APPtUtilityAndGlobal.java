package arc.app.Static;

public class APPtUtilityAndGlobal {

    /* constants used in ARC-APP Package */
    public final static String APP_IMAGES_PATH       = "/resource/img/";
    public final static String APP_IMAGES_URL        = "../img/";
    public final static String APP_TVB_LOGO_URL      = APP_IMAGES_URL + "slogo.png";
    public final static String APP_TVB_LOGO_PATH     = APP_IMAGES_PATH + "slogo.png";
    public final static String APP_END_OF_REPORT     = "*** END OF REPORT ***";
