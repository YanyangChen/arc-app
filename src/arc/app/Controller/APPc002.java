...
@Controller
@Scope("session")
@ACFgFunction(id="APPF002")
@RequestMapping(value=APPtMapping.APPF002)
public class APPc002 extends ACFaAppController {
  ...
  //  Search search = new Search();
	...
	@RequestMapping(value=APPtMapping.APPF002_MAIN, method=RequestMethod.GET)
	...
	@RequestMapping(value=APPtMapping.APPF002_SEARCH_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APPtMapping.APPF002_GET_FORM_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @ACFgTransaction
    @RequestMapping(value=APPtMapping.APPF002_SAVE_AJAX, method=RequestMethod.POST)
    @ResponseBody
