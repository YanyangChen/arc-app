...
import arc.app.Static.APPtGlobal;

@Controller
@Scope("session")
@ACFgFunction(id="APPF006")
@RequestMapping(value=APPtMapping.APPF006)
public class APPc006 extends ACFaAppController {
  ...
  //  Search search = new Search();
    ...
    private class Search extends ACFgSearch {
        public Search() {
            ...
            setCustomSQL("select * from (select A.*, A.adjustment_date as adjustment_datee, im.item_description_1 as item_desc " +
                    ...
                    + "where A.item_no = im.item_no and section_id = '"+APPtGlobal.APP_SECTION_ID+"')");
    ...
    @RequestMapping(value=APPtMapping.APPF006_MAIN, method=RequestMethod.GET)
    public String main(ModelMap model) throws Exception {
        ...
        model.addAttribute("WPItemno", ItemMasterService.getItem_No_for_PP());
    ...
    @RequestMapping(value=APPtMapping.APPF006_SEARCH_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APPtMapping.APPF006_GET_FORM_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    public void update_bothpositive(ARCmItemAdjustmentHistory oldItem, ARCmItemAdjustmentHistory newItem) throws Exception
    {
		...
		if (get_remaining(Invitems)<0)
		{
			...
			throw exceptionService.error("APP105E"); // to be modified
		}
		//update to table
    ...
    public void update_error(ARCmItemAdjustmentHistory oldItem, ARCmItemAdjustmentHistory newItem) throws Exception
    {
    	...
    	{
    	throw exceptionService.error("APP205E"); //Adjustment amount cannot be modified for negative to positive or vice versa
    	}
    	return;
    }
    
    @ACFgTransaction
    @RequestMapping(value=APPtMapping.APPF006_SAVE_AJAX, method=RequestMethod.POST)
    @ResponseBody
