...
@Controller
@Scope("session")
@ACFgFunction(id="APPF005")
@RequestMapping(value=APPtMapping.APPF005)
public class APPc005 extends ACFaAppController {
  ...
  //  Search search = new Search();
    ...
    @RequestMapping(value=APPtMapping.APPF005_MAIN, method=RequestMethod.GET)
    public String main(ModelMap model) throws Exception {
        ...
        model.addAttribute("itemnoselect", ItemMasterService.getItem_No_for_PP()); //acf's function, get data from ACFDB
    ...
    @RequestMapping(value=APPtMapping.APPF005_SEARCH_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APPtMapping.APPF005_GET_FORM_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APPtMapping.APPF005_GET_CONSUMPTION_ITEM_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APPtMapping.APPF005_GET_MATERIAL_CONSUMPTION_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APPtMapping.APPF005_GET_LABOUR_CONSUMPTION_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @ACFgTransaction
    @RequestMapping(value=APPtMapping.APPF005_SAVE_AJAX, method=RequestMethod.POST)
    @ResponseBody
...
// 												return false; //break the loop and won't do any process
 												throw exceptionService.error("APP005E");
 											}
...
// 				 												return false; //break the loop and won't do any process
 															...
 															{	
 																...
 																ARCmItemInventory mininv = Collections.min(Invitems,cii);
 				 												...
 				 												if(cq2 <=APPc006.get_remaining(mininv))
 				 												{
 				 						            			...
 				 						            			{
 				 						            			//mininv.adjusted_quantity = new BigDecimal(0);
 				 						            			cq2 = cq2 - APPc006.get_remaining(mininv);
