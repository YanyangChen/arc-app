...
@Controller
@Scope("session")
@ACFgFunction(id="APPF003")
@RequestMapping(value=APPtMapping.APPF003)

public class APPc003 extends ACFaAppController {
   ...
   // @Autowired APPsModule moduleService;
    ...
    private class Search extends ACFgSearch { //define the class
        public Search() {
            ...
            setCustomSQL("select * from (select po.supplier_code, po.printed_at, sp.supplier_name, po.purchase_order_no, po.department_reference_no, po.purchase_order_date " +
                    ...
                    "where po.supplier_code = sp.supplier_code and section_id = '04')");
    ...
    @RequestMapping(value=APPtMapping.APPF003_MAIN, method=RequestMethod.GET)
    public String main(ModelMap model) throws Exception {
        ...
        model.addAttribute("moduleselect", ItemMasterService.getItem_No_for_PP());
        return view(); // a srting type defined by base class  
    }
    
    @RequestMapping(value=APPtMapping.APPF003_GET_SUPPLIER_DESC_AJAX, method=RequestMethod.POST)
    @ResponseBody 
    ...
    @RequestMapping(value=APPtMapping.APPF003_GET_ITEM_TABLE_AJAX, method=RequestMethod.POST) //get rows of the second grid
    @ResponseBody
    public ACFgResponseParameters getItemTable(@RequestBody ACFgRequestParameters param) throws Exception {                                
     ...
     @RequestMapping(value=APPtMapping.APPF003_GET_FORM_AJAX, method=RequestMethod.POST) //get rows of the first grid
        @ResponseBody
     ...
     @ACFgTransaction
        @RequestMapping(value=APPtMapping.APPF003_SAVE_AJAX, method=RequestMethod.POST)
													...
													@Override
							                         public void callback() throws Exception {
														 List<ARCmItemInventory> ls =new ArrayList<ARCmItemInventory>() ;
								                         	...
								                         	is.receive_date = amendments.get(0).latest_receive_date;
													...
													@Override
							                         public void callback() throws Exception {
														 ...
														 List<ARCmItemInventory> lso =new ArrayList<ARCmItemInventory>() ;
								                         	...
								                         	us.receive_date = amendments.get(0).latest_receive_date;
...
@ACFgTransaction
@RequestMapping(value=APPtMapping.APPF003_GENERATE_NAME_AJAX, method=RequestMethod.POST)
@ResponseBody
...
@ACFgTransaction
@RequestMapping(value=APPtMapping.APPF003_GENERATE_REPORT_AJAX, method=RequestMethod.POST)
@ResponseBody
